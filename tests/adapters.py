...
def run_rmsnorm(
    ...
    rms_norm = transformer.RMSNorm(d_model=d_model, eps=eps)

    rms_norm.load_state_dict(state_dict=state_dict)

    return rms_norm(x=in_features)
...
def get_tokenizer(
    ...
    """
    from cs336_basics.bpe_tokenizer import BytePairEncoder
